...
export ZSH="/home/ralves/.oh-my-zsh"
...
export DENO_DIR="/home/ralves/.deno"
export PATH="$DENO_INSTALL/bin:$PATH"
# Ensuring extra scripts (can be auto generated by Jetbrains Toolbox or other scrips that contain sensible information) are loaded
export PATH="$HOME/.extraScripts:$PATH"

if [ -f ~/.extraScripts/secrets.sh ]; then
    source ~/.extraScripts/secrets.sh
    echo "secrets loaded"
else
    echo "~/.extraScripts/secrets.sh not found."
fi
